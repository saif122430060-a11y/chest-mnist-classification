...
def get_train_transforms():
    ...
    return transforms.Compose([
        ...
        transforms.RandomRotation(20),  # Rotasi random 0-20 derajat
        transforms.RandomAffine(degrees=0, translate=(0.15, 0.15)),  # Translasi random
        transforms.RandomHorizontalFlip(p=0.5),  # Horizontal flip 50%
        transforms.RandomVerticalFlip(p=0.3),  # Vertical flip 30%
        ...
        # Random erasing (simulasi missing data)
...
# ============================================================
# Utility function untuk mendapatkan segmented dataloader
# ============================================================
...
if __name__ == '__main__':
    ...
    print("--- Menguji Model 'DenseNet-121' dengan Augmentation & Segmentation ---\n")
    
    # Test Model
    model = DenseNet121(in_channels=IN_CHANNELS, num_classes=NUM_CLASSES, pretrained=True)
